...
export function BottomNav({
  ...
  return (
    <>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 z-[50] border-t border-border/30 bg-card/95 shadow-[var(--shadow-elevated)] backdrop-blur-md md:hidden touch-manipulation">
