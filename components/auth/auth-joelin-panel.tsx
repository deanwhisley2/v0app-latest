...
export type AuthJoelinChip = { label: string; prompt: string }
...
export function AuthJoelinPanel({
  ...
  useEffect(() => {
    try {
      const k = `nexus_joelin_fab_hint_${scope}_v1`
          ...
          <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="min-w-0">
                <p className="truncate font-semibold">Joelin</p>
                <p className="truncate text-[11px] text-muted-foreground">Ask about Nexus Pro, wallet rules &amp; getting started</p>
              </div>
            </div>
            <button
              type="button"
