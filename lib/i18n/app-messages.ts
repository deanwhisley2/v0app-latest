...
const en: Record<string, string> = {
  ...
  "receipt.header.fundingReceived": "Deposit Confirmed",
  ...
  "receipt.header.tradeSettled": "Capital Returned",
  ...
  "receipt.field.declineReason": "Reason",
  "history.withdrawal.declineReasonPrefix": "Reason:",
  ...
  "notifications.trade.copyCycleMessage": "Principal to Nexus +{{mainAdd}} · Earnings to pocket +{{pocketAdd}} (transfer to Main when ready)",
